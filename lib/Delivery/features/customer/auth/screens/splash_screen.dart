...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    // Navigate to customer login after splash animation.
    // Uses GoRouter (context.go) because we are inside MaterialApp.router —
    // Navigator.pushReplacement does NOT work inside router-based apps.
  ...
  Widget build(BuildContext context) {
    // maybeOf: returns null gracefully if localization hasn't loaded yet.
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    _OrbitingFood(entrance: _entrance, orbit: _orbit, radius: 140),
              ...
              Reveal(
                ...
                child: Text(
                  // Fall back to a hardcoded string if localization isn't ready
                  l?.t('splashTagline') ?? 'Happy meal. Happy life.',
...
// ── Animation sub-widgets (unchanged from original) ──────────────────────────
      ...
      builder: (context, _) {
        return Stack(
          ...
          children: List.generate(_emojis.length, (i) {
            ...
            final raw = ((entrance.value - stagger) / 0.45).clamp(0.0, 1.0);
            final t = Curves.easeOutCubic.transform(raw);

            final r = radius * t;
            return Transform.translate(
              offset: Offset(r * math.cos(currentAngle), r * math.sin(currentAngle)),
              child: Opacity(
                opacity: t,
                child: Transform.scale(
                  scale: 0.4 + 0.6 * t,
